...
void WelcomeScreen() {
    ...
    ClearScreen();
	cout << "Tj Town version 1.5.1" << endl;
    ...
    cout << "Enter your name to begin." << endl << endl;
...
void Bank() {
    ...
    if (bucks > daniBucks) {
        GameOver("Congratulations, you are the richest man in Tj Town! Bucks: " + to_string(bucks));
    } else {
        GameOver("Sorry, you are the poorest man in Tj Town. Bucks: " + to_string(bucks));
    }
}
